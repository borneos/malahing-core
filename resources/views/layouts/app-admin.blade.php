...
<head>
    ...
    <title>{{ $title ?? 'Malahing-core' }}</title>
                                            ...
                                            <div class="widget-content p-0">
                                                <div class="widget-content-wrapper">
                                                    ...
                                                    <div class="widget-content-left">
                                                        <div class="widget-heading">{{ Auth::check() && Auth::user() ? Auth::user()->name : '-' }}</div>
                                                        <div class="widget-subheading opacity-8">{{ Auth::check() && Auth::user() ? Auth::user()->email : '' }}</div>
                                                    </div>
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left">
                                        <div class="btn-group">
                                            <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                                <img width="42" class="rounded-circle" src="https://ui-avatars.com/api/?name={{ Auth::check() && Auth::user()->name ? Auth::user()->name : '' }}&background=random" alt="">
                                                <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                            </a>
                                                ...
                                                <div class="dropdown-menu-header">
                                                    <div class="dropdown-menu-header-inner bg-info">
                                                        ...
                                                        <div class="menu-header-content text-left">
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    <div class="widget-content-left mr-3"><img width="42" class="rounded-circle" src="https://ui-avatars.com/api/?name={{ Auth::check() && Auth::user()->name ? Auth::user()->name : '' }}&background=random" alt=""></div>
                                                                    <div class="widget-content-left">
                                                                        <div class="widget-heading">{{ Auth::check() && Auth::user()->name ? Auth::user()->name : '' }}</div>
                                                                        <div class="widget-subheading opacity-8">{{ Auth::check() && Auth::user()->email ? Auth::user()->email : '' }}</div>
                                                                    </div>
                                                                    <div class="widget-content-right mr-2">
                                                                        <form action="{{ route('logout') }}" method="POST">
                                                                            @csrf
                                    ...
                                    <div class="widget-content-left  ml-3 header-user-info">
                                        <div class="widget-heading">{{ Auth::check() && Auth::user()->name ? Auth::user()->name : '' }}</div>
                                        <div class="widget-subheading">{{ Auth::check() && Auth::user()->name ? Auth::user()->email : '' }}</div>
                                    </div>
