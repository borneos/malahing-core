@extends('layouts.app-admin', ['title' => 'Banner'])
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-center" style="margin-bottom:0%;">
                                <img style="width: 25%;border: 0px solid; border-radius: 10px;" src="{{ URL::to($banner->image) }}" id="viewer" alt="" />
                            </div>
                            <div class="text-right mt-2">
                                <a href="{{ route('admin.banners.index') }}" class="mb-2 mr-2 btn btn-icon btn-light btn-lg"><i class="pe-7s-back btn-icon-wrapper"></i>Back</a>
